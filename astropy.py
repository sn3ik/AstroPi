...
def indi():
    ...
    os.chdir("indi")
    os.system("git pull origin")
    os.system("cmake -B ../build-indi ../indi -DCMAKE_INSTALL_PREFIX=/usr -DCMAKE_BUILD_TYPE=Release || { echo 'INDI configuration failed'; exit 1; }")
    os.chdir("..")
    os.chdir("build-indi")
...
def indi3rdparty():
    ...
    os.system("git pull origin")
    os.system("cmake -B ../build-indi-lib ../indi-3rdparty -DCMAKE_INSTALL_PREFIX=/usr -DBUILD_LIBS=1 -DCMAKE_BUILD_TYPE=Release || { echo 'INDI 3dparty configuration failed'; exit 1; }")
    os.chdir("..")
    ...
    os.system("cmake -B ../build-indi-3rdparty ../indi-3rdparty -DCMAKE_INSTALL_PREFIX=/usr -DCMAKE_BUILD_TYPE=Release || { echo 'INDI 3dparty configuration failed'; exit 1; }")
    os.chdir("..")
